...
public class PedidoPagamentoRepository {
    ...
    // Retorna todos os pedidos de um determinado dia com informações detalhadas
    public List<PedidoPagamento> findByDateWithDetails(String date) {
        String sql = "SELECT pedido_pagamento.cod_pedido, pedido_pagamento.descricao, pedido_pagamento.valor, pedido_pagamento.meio_pagamento, pedido_pagamento.status, pedido_pagamento.data_pedido, pedido_pagamento.fk_cliente_cpf, pedido_pagamento.cod_pagamento, " +
                ...
                "LEFT JOIN entrega_entregador_pedido_cliente ON pedido_pagamento.cod_pedido = entrega_entregador_pedido_cliente.fk_pedido_pagamento_cod_pedido " +
                "LEFT JOIN entregador ON entrega_entregador_pedido_cliente.fk_entregador_cod_entregador = entregador.cod_entregador " +
                "WHERE DATE(pedido_pagamento.data_pedido) = ?";
        return jdbcTemplate.query(sql, new PedidoComProdutosExtractor(), date);
    }

    // Retorna todos os pedidos de um determinado mês com informações detalhadas
    public List<PedidoPagamento> findByMonthWithDetails(String month) {
        String sql = "SELECT pedido_pagamento.cod_pedido, pedido_pagamento.descricao, pedido_pagamento.valor, pedido_pagamento.meio_pagamento, pedido_pagamento.status, pedido_pagamento.data_pedido, pedido_pagamento.fk_cliente_cpf, pedido_pagamento.cod_pagamento, " +
                ...
                "LEFT JOIN entrega_entregador_pedido_cliente ON pedido_pagamento.cod_pedido = entrega_entregador_pedido_cliente.fk_pedido_pagamento_cod_pedido " +
                "LEFT JOIN entregador ON entrega_entregador_pedido_cliente.fk_entregador_cod_entregador = entregador.cod_entregador " +
                "WHERE MONTH(pedido_pagamento.data_pedido) = ?";
        return jdbcTemplate.query(sql, new PedidoComProdutosExtractor(), month);
    }

    // Retorna todos os pedidos de um determinado ano com informações detalhadas
    public List<PedidoPagamento> findByYearWithDetails(String year) {
        String sql = "SELECT pedido_pagamento.cod_pedido, pedido_pagamento.descricao, pedido_pagamento.valor, pedido_pagamento.meio_pagamento, pedido_pagamento.status, pedido_pagamento.data_pedido, pedido_pagamento.fk_cliente_cpf, pedido_pagamento.cod_pagamento, " +
                ...
                "LEFT JOIN entrega_entregador_pedido_cliente ON pedido_pagamento.cod_pedido = entrega_entregador_pedido_cliente.fk_pedido_pagamento_cod_pedido " +
                "LEFT JOIN entregador ON entrega_entregador_pedido_cliente.fk_entregador_cod_entregador = entregador.cod_entregador " +
                "WHERE YEAR(pedido_pagamento.data_pedido) = ?";
        return jdbcTemplate.query(sql, new PedidoComProdutosExtractor(), year);
    }
